...
public void addBookToDashboard(String title, String author, String category) {
    ...
    private void initComponents() {
        ...
        jButtonLogout.setActionCommand("LOGOUT");
                            ...
                            .addGroup(jPanelAdminLayout.createSequentialGroup()
                                ...
                                .addGroup(jPanelAdminLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanelAdminLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(jTAddAuthor, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jTAddTitle, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
...
private void updateTableByCategory(String selectedCategory) {
    ...
    for (Book book : books) {
        if ((selectedCategory.equals("All") || selectedCategory.equals(book.getCategory())) && !isBookBorrowed(book.getTitle(), book.getAuthor())) {
            model.addRow(new Object[]{book.getTitle(), book.getAuthor(), false}); // Assuming false means not borrowed
        }
    }
}
//For Category
...
// Get the user's desktop directory
    ...
    // Write the data to a text file inside the folder
...
private void sortAvailableBooks() {
    ...
    DefaultTableModel modelAvailable = (DefaultTableModel) jTableAvailable.getModel();
    modelAvailable.setRowCount(0); // Clear the table
    for (Book book : availableBooks) {
    ...
    if (title.isEmpty() || author.isEmpty() || category.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Please fill in all fields (Title, Author, Category)");
...
DefaultTableModel modelAvailable = (DefaultTableModel) jTableAvailable.getModel();
    ...
    String titleToRemove = (String) modelAvailable.getValueAt(selectedRow, 0);
    String authorToRemove = (String) modelAvailable.getValueAt(selectedRow, 1);

    // Find the book in the available books list and remove it
    ...
    if (bookToRemove != null) {
        ...
        books.remove(bookToRemove); // Remove the book from the books list
